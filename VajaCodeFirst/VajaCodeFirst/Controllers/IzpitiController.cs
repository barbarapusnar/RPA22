...
namespace VajaCodeFirst.Controllers
{
    public class IzpitiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Datum,StudentID,PredmetID,Ocena")] Izpit izpit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Datum,StudentID,PredmetID,Ocena")] Izpit izpit)
        {
            if (ModelState.IsValid)
            {
